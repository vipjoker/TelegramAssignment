...
public class MiniStackedBarChartRenderer implements Renderer {
    ...
    public MiniStackedBarChartRenderer(DrawData scaleData, ChartData chartData) {
    ...
    public void update(long elapsedTimeMs) {
        ...
        final long maxTotal = chartData.getMaxTotal();
        drawData.setMaxTotalMiniChart(maxTotal);
    }
    ...
    private void drawChartY0(Canvas canvas, long minX, long maxX, LineData[] lineDates) {
        if (chartData != null) {
            ...
            long maxTotal = drawData.getMaxTotalMiniChart();
            for (int i = 0; i < chartData.size(); i++) {
                ...
                for (int j = 0; j < lineDates.length; j++) {
                    ...
                    canvas.drawRect(barRect, graphPaint);
                    startPointY += graphY;
